...
namespace Repository.UserRepositories
{
...

    {
        ...
        public async Task<PagedList<Employee>> GetEmployeesAsync(Guid companyId, EmployeeParameters employeeParameters, bool trackChanges)
        {
            ...
            //return await FindByCondition(c => c.CompanyId.Equals(companyId), trackChanges).OrderBy(c => c.Name).Skip((employeeParameters.PageNumber - 1) * employeeParameters.PageSize).Take(employeeParameters.PageSize).ToListAsync();
        }
    }
}